...
$directoriesToRemove = @("\.containers\ftp-server\**", "\.containers\database\**", "\.containers\cache\**", "\backend\src\vimi_web\api\migrations\00*", "\backend\src\vimi_web\worker\migrations\00*")
