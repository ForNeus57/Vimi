...
from vimi_web.api.views import ArchitectureAllView, UploadNetworkInput
...
urlpatterns = [
    ...
    path('network_input/<int:architecture_id>', UploadNetworkInput.as_view(), name='upload_network_input'),
