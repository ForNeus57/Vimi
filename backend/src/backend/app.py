"""Module responsible for main application logic."""
...
class Application:
    ...
    def config_flask(self) -> Flask:
        ...
        def models_extensions() -> Tuple[Dict, int]:
        ...
        def models_upload() -> Tuple[Dict, int]:
            try:
                ...
                if extension not in app.config['ALLOWED_EXTENSIONS']:
                    raise WrongExtensionProvided(extension)
                ...
                return {'error': f'File too large, exceeded the {app.config['MAX_CONTENT_LENGTH']} limit'}, 413
